...
Yêu cầu: Node.js ≥ 22 (dùng module built-in `node:sqlite`, không cần cài native dependency).
...
Database SQLite tự tạo tại `data/club.db`. Muốn xoá toàn bộ dữ liệu làm lại từ đầu: tắt server và xoá thư mục `data/`.
